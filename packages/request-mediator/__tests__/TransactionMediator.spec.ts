...
import { by, key, Provider, provider, Registration, singleton, whenScope, inject } from 'ts-ioc-container';
...
@provider(singleton(), whenScope((s) => s.hasTag(Scope.Application)))
