...
import { by, key, Provider, provider, Registration, singleton, whenScope, hasTags, inject } from 'ts-ioc-container';
...
@provider(singleton(), whenScope(hasTags.someOf(Scope.Application)))
