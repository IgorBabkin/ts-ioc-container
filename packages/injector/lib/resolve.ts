...
export const resolve = <Context>(context: Context) => <T>(value: constructor<T>, ...deps: unknown[]) => {
...
export const inject = <Context>(fn: Fn<Context, unknown>) => attr(INJECT_METADATA_KEY)((context: Context) => run(fn(pure(context))));
