...
| [Injector strategies](epics/injector-strategies.md)         | `__tests__/specs/injector-strategies.spec.ts`     | Planned only when a story needs performance coverage                                                                                   | ADR 0002            |
