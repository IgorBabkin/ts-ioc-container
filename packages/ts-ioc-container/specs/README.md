...
6. Update `.readme.hbs.md` when public documentation changes.
7. Add an ADR only when the change makes a durable architecture or process
   decision.

## Traceability

| Spec                                                        | Acceptance tests                                  | Benchmarks                                                                                                                             | Related ADRs        |
| ----------------------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| [Dependency resolution](epics/dependency-resolution.md)     | `__tests__/specs/dependency-resolution.spec.ts`   | `__benchmarks__/specs/dependency-resolution.ts-ioc-container.bench.ts`, `__benchmarks__/specs/dependency-resolution.tsyringe.bench.ts` | —                   |
| [Scoped lifecycle](epics/scoped-lifecycle.md)               | `__tests__/specs/scoped-lifecycle.spec.ts`        | Planned only when a story needs performance coverage                                                                                   | ADR 0001, ADR 0006  |
| [Dependency registration](epics/dependency-registration.md) | `__tests__/specs/dependency-registration.spec.ts` | Planned only when a story needs performance coverage                                                                                   | ADR 0003            |
| [Provider behavior](epics/provider-behavior.md)             | `__tests__/specs/provider-behavior.spec.ts`       | Planned only when a story needs performance coverage                                                                                   | ADR 0004            |
| [Token-based injection](epics/token-based-injection.md)     | `__tests__/specs/token-based-injection.spec.ts`   | Planned only when a story needs performance coverage                                                                                   | ADR 0005, ADR 0009  |
| [Injector strategies](epics/injector-strategies.md)         | `__tests__/specs/injector-strategies.spec.ts`     | Planned only when a story needs performance coverage                                                                                   | ADR 0002, ADR 0019  |
| [Lifecycle hooks](epics/lifecycle-hooks.md)                 | `__tests__/specs/lifecycle-hooks.spec.ts`         | Planned only when a story needs performance coverage                                                                                   | ADR 0007            |
