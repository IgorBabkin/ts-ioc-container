import { IContainer, AutoMockedContainer, Container, SimpleInjector } from '../../lib';
...
describe('UnitTestSimpleLocator', () => {
    ...
    function createSimpleLocator() {
        return new Container(new SimpleInjector()).map((l) => new AutoMockedContainer(l, mockRepository));
    }
