...
describe('Singleton', function () {
    it('should resolve the same dependency if provider registered per root', function () {
        const container = new Container(injector, { tags: ['home'] }).add(Registration.fromClass(Logger));
    ...
    it('should resolve unique dependency for every registered scope', function () {
        const container = new Container(injector).add(Registration.fromClass(Logger));
