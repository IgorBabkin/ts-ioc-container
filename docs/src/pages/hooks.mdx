...
import onConstructSpecCode from "../../../packages/ts-ioc-container/__tests__/hooks/OnConstruct.spec.ts?raw";
import onDisposeSpecCode from "../../../packages/ts-ioc-container/__tests__/hooks/OnDispose.spec.ts?raw";
