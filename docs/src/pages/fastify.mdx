...
title: TypeScript Dependency Injection with Fastify
description: Use ts-ioc-container with Fastify for TypeScript dependency injection, request scopes, decorators, hooks, and service cleanup
---
