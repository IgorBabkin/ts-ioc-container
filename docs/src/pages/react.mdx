...
title: TypeScript Dependency Injection with React
description: Use ts-ioc-container with React Context and hooks for TypeScript dependency injection, application scopes, page scopes, and widget scopes
---
