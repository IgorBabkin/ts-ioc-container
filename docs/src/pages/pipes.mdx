...
| Question it answers | Can this registration apply to this scope? | Can this provider be resolved for this invocation scope? |
...
// Resolving limit:
// Can this provider be resolved for this invocation scope?
@register(
  bindTo('AdminConsole'),
