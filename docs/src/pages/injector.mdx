...
import simpleInjectorSpecCode from "../../../packages/ts-ioc-container/__tests__/injector/SimpleInjector.spec.ts?raw";
import proxyInjectorSpecCode from "../../../packages/ts-ioc-container/__tests__/injector/ProxyInjector.spec.ts?raw";
