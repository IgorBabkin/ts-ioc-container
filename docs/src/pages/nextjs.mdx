...
title: Dependency Injection in Next.js with TypeScript
description: Use ts-ioc-container with Next.js for TypeScript dependency injection, request scopes, server handlers, and application services
---
