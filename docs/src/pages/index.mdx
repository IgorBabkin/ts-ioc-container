...
- Spec-driven documentation backed by executable acceptance tests
...
- [Spec-driven](/ts-ioc-container/spec-driven) - Epics, use cases, acceptance tests, ADRs, and documentation workflow
