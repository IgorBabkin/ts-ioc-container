...
description: Fast TypeScript IoC container with decorators, tokens, scoped lifecycles, lifecycle hooks, lazy injection, and customizable providers
---
...
for real application architecture.
